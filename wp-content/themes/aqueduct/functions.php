...
// BRANNDON
function lista_posts( $cat ) {

	$listaPost = new WP_Query( array(
		'cat'				=> $cat,
		'order_by'			=> 'date',
		'order'				=> 'DESC',
		'posts_per_page'	=> 6
	...
	if( $listaPost->have_posts() ) {

		echo '<ul>';
			while( $listaPost->have_posts() ) {
				$listaPost->the_post();
				...
				echo '<li>';
					echo '<a href="'. get_the_permalink() .'">';
						echo '<div class="content-img">';
							echo '<img src="'. get_bloginfo( 'template_directory' ) .'/img/teste-post.jpg" alt=""/>';
						echo '</div>';
						echo '<div class="content">';
							echo '<div class="border">';
								echo '<h4 class="maven_promedium">'. get_the_title() .'</h4>';
								echo '<span class="maven_promedium date">'. get_the_date('j l Y') .'</span>';
								echo '<span class="maven_promedium category">'. $catName .'</span>';
						echo '</div>';

						echo '<div class="clear"></div>';
							echo '<p class="text lato">';
							if (get_the_content()) {
								echo wp_html_excerpt( wp_strip_all_tags( get_the_content() ), 100, '<span>[...] Continuar lendo.</span>' );
							} else {
								echo "Nenhuma descrição cadastrada.";
							}
							echo '</p>';
						echo '</div>';
					echo '</a>';
		...
		echo '<p class="posts-not-found">Nenhum post encontrado nesta categoria.</p>';
	}
				...
				echo '<li>';
					echo '<a href="'. get_the_permalink() .'">';
						...
						echo '<div class="content">';
							echo '<div class="border">';
								echo '<h4 class="maven_promedium">'. get_the_title() .'</h4>';
								echo '<span class="maven_promedium date">'. get_the_date('j') . ' de ' . get_the_date('l') . ' de ' . get_the_date('Y') .'</span>';
								echo '<span class="maven_promedium category">'. $category_name .'</span>';
						echo '</div>';
